        ...
        <div class="row">
            <div class="col-6">
                <div class="user-photo">
                    <img :src="$store.state.user.photo" alt="" srcset="">
                </div>
            ...
            <div class="col-6">
                <div class="user-photo">
                    <img :src="$store.state.pk.opponent_photo" alt="" srcset="">
                </div>
...
export default{
    setup() {
        ...
        let match_btn_info = ref("Begin Match");

        const click_match_btn = () => {
            if (match_btn_info.value === "Begin Match"){
                match_btn_info.value = "Cancel";
                store.state.pk.socket.send(JSON.stringify({
                    event: "start-matching",
                }))
            }else{
                match_btn_info.value = "Begin Match";
                store.state.pk.socket.send(JSON.stringify({
                    event: "stop-matching",
                }))
            }

                            ...
                            <div class="modal-dialog modal-xl">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input v-model="botadd.title" type="text" class="form-control" id="add-bot-title" placeholder="Please type Bot name">
                                    </div>
                                    <div class="mb-3">
                                        <label for="add-bot-description" class="form-label">Bot Description</label>
                                        <textarea v-model="botadd.description" class="form-control" id="add-bot-description" rows="3" placeholder="Please type Bot description"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="add-bot-content" class="form-label">Bot Content</label>
                                        <VAceEditor
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" @click="add_bots">Create</button>
                                        ...
                                        <div class="modal fade" :id="'update-bot-modal-' + bot.id" tabindex="-1">
                                            <div class="modal-dialog modal-xl">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label for="add-bot-title" class="form-label">Name</label>
                                                        <input v-model="bot.title" type="text" class="form-control" id="add-bot-title" placeholder="Please type Bot name">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="add-bot-description" class="form-label">Bot Description</label>
                                                        <textarea v-model="bot.description" class="form-control" id="add-bot-description" rows="3" placeholder="Please type Bot description"></textarea>
                                                    </div>
                                                    <div class="mb-3">d
                                                        <label for="add-bot-content" class="form-label">Bot Content</label>
                                                        <VAceEditor
